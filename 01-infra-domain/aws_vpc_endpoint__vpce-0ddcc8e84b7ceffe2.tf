...
# aws_vpc_endpoint.vpce-0ddcc8e84b7ceffe2:
resource "aws_vpc_endpoint" "vpce-0ddcc8e84b7ceffe2" {
  policy = jsonencode(
    {
      Statement = [
        {
  ...
  service_name = format("com.amazonaws.%s.codecommit",data.aws_region.current.name)
  subnet_ids = [
